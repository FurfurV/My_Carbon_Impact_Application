...
public class MyForm extends Application {
    ...
    private GridPane buttonsPane, buttonsBottomPane, grid, textFieldPad;
    private Button btnAdd, btnRemove, btnList, btnSummary, btnLoad, btnSave, btnExit;
    private HBox hbBtnAdd, hbBtnRem, hbBtnList, hbBtnSummary, hbBtnLoad, hbBtnSave, hbBtnExit;
...
//▚▚▚▚▚▚▚▚▚▚▚▚▚▚▚▚▚▚▚▚ scene▚▚▚▚▚▚▚▚▚▚▚▚▚▚▚▚▚▚▚▚
    ...
    public void addActivity(ArrayList<Activity> actList){
        int points= Integer.parseInt(pointsBox.getText());
        ...
        if( points<-10 || points>10){
           System.out.println("Cant add, incorrect points!");
            ...
            act.setActivity(activityBox.getText());
